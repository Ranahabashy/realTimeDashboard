...
import { UPDATE_COMPANY_MUTATION } from "@/graphql/mautations";
import { SelectOptionWithAvatar } from "@/components/select-option-with-avatar";
import { CompanyContactsTable } from "./cotacts-table";
        ...
        >
          <Form {...formProps} layout="vertical">
            ...
            >
              <Select
                {...selectPropsUsers}
                options={queryResultUsers.data?.data?.map(({ id, name, avatarUrl }) => ({
                  value: id,
                  label: (
